...
describe("indexProject", () => {
    ...
    it("indexes a directory with multiple markdown files and returns correct stats", async () => {
        await writeFile(join(project.wikiDir, "page-one.md"), `---\ntitle: Page One\ntags: [alpha]\n---\n\n# Page One\n\nContent of page one.\n`, "utf8");
        await writeFile(join(project.wikiDir, "page-two.md"), `---\ntitle: Page Two\ntags: [beta]\n---\n\n# Page Two\n\nContent of page two. See [[page-one]].\n`, "utf8");
        await writeFile(join(project.wikiDir, "page-three.md"), `---\ntitle: Page Three\n---\n\nThird page content.\n`, "utf8");
